      ...
      <Surface className="w-full max-w-4xl rounded-2xl p-6">
        <Form onSubmit={onSubmit}>
          <Fieldset className="w-full">
            <Fieldset.Legend className="font-bold text-4xl">
              Doctor Profile
            </Fieldset.Legend>
            ...
            <Fieldset.Group className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <TextField isRequired name="doctorName">
                ...
                <Input variant="secondary" placeholder="Dr. John Doe" />
                <FieldError />
              </TextField>
              ...
              >
                ...
                <Select.Popover>
                  <ListBox>
                    ...
                    <ListBox.Item id="medicine" textValue="General Medicine">
                      General Medicine
                      <ListBox.ItemIndicator />
                    </ListBox.Item>
                    ...
                    <ListBox.Item id="nephrology" textValue="Nephrology">
                      Nephrology
                      <ListBox.ItemIndicator />
                    </ListBox.Item>
                    ...
                    <ListBox.Item id="gynecology" textValue="Gynecology">
                    ...
                    <ListBox.Item id="psychiatry" textValue="Psychiatry">
                      Psychiatry
                      <ListBox.ItemIndicator />
                    </ListBox.Item>

                    <ListBox.Item id="ophthalmology" textValue="Ophthalmology">
                      Ophthalmology
                      <ListBox.ItemIndicator />
                    </ListBox.Item>
                    ...
                    <ListBox.Item id="endocrinology" textValue="Endocrinology">
                      Endocrinology
                      <ListBox.ItemIndicator />
                    </ListBox.Item>
                    ...
                    <ListBox.Item id="pulmonology" textValue="Pulmonology">
                      Pulmonology
                      <ListBox.ItemIndicator />
                    </ListBox.Item>
                    ...
                    <ListBox.Item id="radiology" textValue="Radiology">
                      Radiology
                      <ListBox.ItemIndicator />
                    </ListBox.Item>

                    <ListBox.Item id="pathology" textValue="Pathology">
                      Pathology
                      <ListBox.ItemIndicator />
                    </ListBox.Item>

                    <ListBox.Item id="dentistry" textValue="Dentistry">
                      Dentistry
                      <ListBox.ItemIndicator />
                    </ListBox.Item>
                  </ListBox>
                ...
                <Description>Select the doctor's specialization.</Description>
              ...
              <TextField isRequired name="experience">
                ...
                <Input type="number" variant="secondary" placeholder="10" />
                <FieldError />
              </TextField>
              ...
              <TextField isRequired name="consultationFee">
                ...
                <Input type="number" variant="secondary" placeholder="800" />
                <FieldError />
              </TextField>
              ...
              <TextField isRequired name="hospitalName">
                ...
                <Input variant="secondary" placeholder="City Hospital" />
                <FieldError />
              </TextField>
              ...
              >
                ...
                <Description>Select the doctor's available day.</Description>
                <FieldError />
              </Select>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <TextField isRequired name="startTime">
                  ...
                  <div className="relative">
                    ...
                    <Input type="time" variant="secondary" className="pl-10" />
                  </div>
                ...
                <TextField isRequired name="endTime">
                  ...
                  <Description>Select the doctor's available time.</Description>
